...
const createBooking = async (req, res) => {
  ...
  if (razorpay_order_id && razorpay_payment_id && razorpay_signature) {
    ...
    // Inside createBooking in bookingControllers.js

    console.log("--------------------------------");
    console.log("1. Order ID:", razorpay_order_id);
    console.log("2. Payment ID:", razorpay_payment_id);
    console.log("3. Signature from Frontend:", razorpay_signature);
    console.log("4. Signature Generated by Backend:", expectedSignature);
    console.log("--------------------------------");
